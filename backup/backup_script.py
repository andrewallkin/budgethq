...
BACKUP_SCHEDULE_HOUR = int(os.environ.get("BACKUP_SCHEDULE_HOUR", "0"))
BACKUP_SCHEDULE_MINUTE = int(os.environ.get("BACKUP_SCHEDULE_MINUTE", "30"))
BACKUP_TIMEZONE = os.environ.get("BACKUP_TIMEZONE", "Africa/Johannesburg")
...
def main():
    ...
    try:
        ...
        logger.info(f"Schedule: Daily at {BACKUP_SCHEDULE_HOUR:02d}:{BACKUP_SCHEDULE_MINUTE:02d} {BACKUP_TIMEZONE}")
    except Exception as e:
